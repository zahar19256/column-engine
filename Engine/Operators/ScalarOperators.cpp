...
template <NumericColumn LeftColumnType , NumericColumn RightColumnType , typename ResultColumnType>
std::shared_ptr<Column> ColumnSub(std::shared_ptr<LeftColumnType> left , std::shared_ptr<RightColumnType> right , ResultColumnType result) {
    result->Resize(left->Size());
    auto* data = result->Data();
    const auto* left_data = left->Data();
    const auto* right_data = right->Data();
...
std::shared_ptr<Column> ExecuteBinaryOpTyped(BinaryExprType op , std::shared_ptr<LeftColumnType> left , std::shared_ptr<RightColumnType> right , std::shared_ptr<ResultColumnType> result) {
    switch(op) {
...
std::shared_ptr<Column> ExecuteBinaryOp(BinaryExprType op , const std::shared_ptr<LeftColumnType>& left , const std::shared_ptr<RightColumnType>& right , ColumnType result_type) {
...
std::shared_ptr<Column> DispatchRightBinaryOp(BinaryExprType op , std::shared_ptr<LeftColumnType> left , std::shared_ptr<Column> right , ColumnType result_type) {
...
std::shared_ptr<Column> DispatchLeftBinaryOp(BinaryExprType op , std::shared_ptr<Column> left , std::shared_ptr<Column> right , ColumnType result_type) {
    switch (left->GetType()) {
        case ColumnType::Int8:
