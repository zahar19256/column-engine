    ...
    case AggregationType::Distinct:
        ...
        case ColumnType::String:
            return std::make_unique<
                TypedAggregationState<std::string, StringColumn, Int64Column, CountDistinctOperator>>();
        case ColumnType::Date:
            return std::make_unique<TypedAggregationState<int64_t, DateColumn, Int64Column, CountDistinctOperator>>();
        case ColumnType::Timestamp:
            return std::make_unique<
                TypedAggregationState<int64_t, TimeStampColumn, Int64Column, CountDistinctOperator>>();
        default:
