...
inline std::shared_ptr<ScalarExpr> MakeBinaryExpr(std::shared_ptr<ScalarExpr> left, std::shared_ptr<ScalarExpr> right,
                                                  BinaryExprType type, ColumnType out_type = ColumnType::Unknown) {
    return std::make_shared<BinaryExpr>(std::move(left), std::move(right), type, out_type);
}

inline std::shared_ptr<ScalarExpr> MakeAddExpr(std::shared_ptr<ScalarExpr> left, std::shared_ptr<ScalarExpr> right,
                                               ColumnType out_type = ColumnType::Unknown) {
    return MakeBinaryExpr(std::move(left), std::move(right), BinaryExprType::Add, out_type);
}

inline std::shared_ptr<ScalarExpr> MakeSubExpr(std::shared_ptr<ScalarExpr> left, std::shared_ptr<ScalarExpr> right,
                                               ColumnType out_type = ColumnType::Unknown) {
    return MakeBinaryExpr(std::move(left), std::move(right), BinaryExprType::Sub, out_type);
}

inline std::shared_ptr<ScalarExpr>
MakeCaseWhenExpr(std::vector<std::pair<std::shared_ptr<PredicateExpr>, std::shared_ptr<ScalarExpr>>> cases,
...
inline std::shared_ptr<ScalarExpr> MakeRegexpReplaceExpr(std::shared_ptr<ScalarExpr> expression, std::string pattern,
                                                         std::string replacement) {
    return std::make_shared<UnaryExpr>(std::move(expression), UnaryExprType::RegexpReplace, std::move(pattern),
